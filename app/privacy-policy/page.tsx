    ...
    <BackgroundImage>
      ...
      <main className="flex-1 overflow-y-auto p-8 flex justify-center">
        <div className="w-full max-w-4xl mx-auto space-y-8 bg-white/80 p-6 rounded-lg shadow-lg text-gray-800">
          ...
          <p className="text-sm text-gray-600 text-center">Last updated: July 30, 2025</p>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              <strong>Application</strong> refers to DamageSnap, the software program provided by the Company.
            </li>
            <li>
              <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to DamageSnap.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to DamageSnap, accessible from https://db.xoperr.dev/docs
            </li>
            <li>
          ...
          <h4 className="text-lg font-medium mb-1">Information Collected while Using the Application</h4>
          <p>
          ...
          <p>
            ...
            information may be uploaded to the Company&apos;s servers and/or a Service Provider&apos;s server or it may
            be simply stored on Your device.
          </p>
          <p>You can enable or disable access to this information at any time, through Your Device settings.</p>

          <h3 className="text-xl font-medium mt-6 mb-2">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              <strong>To provide You with news,</strong> special offers and general information about other goods,
          ...
          <h4 className="text-lg font-medium mb-1">Business Transactions</h4>
          <p>
          ...
          <h4 className="text-lg font-medium mb-1">Law enforcement</h4>
          <p>
          ...
          <h4 className="text-lg font-medium mb-1">Other legal requirements</h4>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>By email: msmetanskyi@gmail.com</li>
          </ul>
        </div>
      </main>
      <AppFooter></AppFooter>
